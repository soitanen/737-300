...
setprop("/systems/electrical/outputs/instr-ignition-switch", Lmain_bus_volts);
    ...
    if ( getprop("/controls/switches/inboard-lights") ) {
        setprop("/systems/electrical/outputs/inboard-lights",Lmain_bus_volts);
    } else {
        setprop("/systems/electrical/outputs/inboard-lights", 0.0 );
    }
    
   if ( getprop("/controls/switches/outboard-lights") ) {
        setprop("/systems/electrical/outputs/outboard-lights",Lmain_bus_volts);
    } else {
        setprop("/systems/electrical/outputs/outboard-lights", 0.0 );
    }
    ...
    if ( getprop("/controls/switches/taxi-light" ) ) {
        setprop("/systems/electrical/outputs/taxi-light", Lmain_bus_volts);
    } else {
    ...
    if ( getprop("/controls/switches/logo-lights" ) ) {
      ...
      if ( getprop("/controls/switches/instruments-lights" ) ) {
        setprop("/systems/electrical/outputs/instruments-lights", Lmain_bus_volts);
    } else {
        setprop("/systems/electrical/outputs/instruments-lights", 0.0);
    }
if ( getprop("/controls/switches/seatbelt-sign" ) ) {
        setprop("/systems/electrical/outputs/seatbelt-sign", Lmain_bus_volts);
    } else {
        setprop("/systems/electrical/outputs/seatbelt-sign", 0.0);
    }	    
